...
async def test_ollama_complete_posts_to_endpoint():
    ...
    with patch("claude_tts.providers.ollama.httpx.AsyncClient") as mock_client_cls:
...
async def test_ollama_complete_passes_max_tokens():
    ...
    with patch("claude_tts.providers.ollama.httpx.AsyncClient", return_value=FakeClient()):
