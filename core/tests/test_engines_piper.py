...
def test_piper_synthesize_calls_subprocess(tmp_path):
    ...
    with patch("claude_code_talker.engines.piper.subprocess.run") as mock_run, \
         patch("claude_code_talker.engines.piper.tempfile.mkstemp") as mock_mkstemp, \
         patch("claude_code_talker.engines.piper.Path.read_bytes") as mock_read, \
         patch("claude_code_talker.engines.piper.os.close"), \
         patch("claude_code_talker.engines.piper.os.unlink"):
